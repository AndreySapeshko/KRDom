...
from backend.pdf.schemas.calc_result import PdfMaterialRow, PdfGroupSectionRow, PdfGroupBlock, PdfSectionTotal, \
    PdfSummary, PdfHeader, PdfReportV1

from backend.tests.core.test_golden_calc import load_items

MATERIAL_SECTIONS = [
    MaterialIn(
        section_id="BOARD_50x150x6",
        width_mm=50,
        height_mm=150,
        length_mm=6000,
        kind="GOST 8683 1-2 grade"
    ),
    MaterialIn(
        section_id="BOARD_50x200x6",
        width_mm=50,
        height_mm=200,
        length_mm=6000,
        kind="GOST 8683 1-2 grade"
